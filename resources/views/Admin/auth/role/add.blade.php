            ...
            <section id="content" class="container">
                    ...
                    <div class="block-area" id="text-input">
                        ...
                        <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <span>角色名：</span>
                                    <input type="text" class="form-control m-b-10" placeholder="请输入角色名称" name='name'>
                                    <span>权限：</span>
                                    @foreach($auth as $auth)
                                    <label class="checkbox-inline">
                                        <input class="userCheckbox" type="checkbox" ><span>{{$auth->auth_name}}</span>
                                    </label>
                                    @endforeach
                                </div>
                                <div class="col-lg-12">
       ...
       <script src="{{ asset('Admin/js/jquery.min.js') }}"></script> <!-- jQuery Library -->
        ...
        <script>
            ...
            $('#submitButton').click(function(){
                ...
                $.ajax({url:'/Admin/auth/role/add',
                    type:'post',
                    data:{"name":$("input[name='name']").val(),"auth":auth},
