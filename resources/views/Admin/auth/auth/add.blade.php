...
<ul class="list-unstyled side-menu">
            ...
            <section id="content" class="container">
                ...
                <div class="block-area" id="text-input">
                    ...
                    <form action="/Admin/auth/add" method="post">
                        <div class="row">
                                {{ csrf_field() }}
                                <div class="col-lg-4">
                                    <span>权限名：</span>
                                    <input type="text" class="form-control m-b-10" placeholder="请输入权限名称" name='auth_name'>
                                    <span>url列表：</span>
                                    <textarea class="form-control overflow" rows="10" placeholder="不同地址以回车隔开" style="overflow: hidden;" tabindex="5003" name="urls"></textarea>
                                </div>
                                <div class="col-lg-12">
